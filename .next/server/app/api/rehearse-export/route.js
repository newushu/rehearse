(()=>{var a={};a.id=248,a.ids=[248],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},3033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},6487:()=>{},6748:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>C,patchFetch:()=>B,routeModule:()=>x,serverHooks:()=>A,workAsyncStorage:()=>y,workUnitAsyncStorage:()=>z});var d={};c.r(d),c.d(d,{GET:()=>w});var e=c(5736),f=c(9117),g=c(4044),h=c(9326),i=c(2324),j=c(261),k=c(4290),l=c(5328),m=c(8928),n=c(6595),o=c(3421),p=c(7679),q=c(1681),r=c(3446),s=c(6439),t=c(1356),u=c(8908),v=c(641);async function w(a){try{let b=a.nextUrl.searchParams.get("performanceId");if(!b)return v.NextResponse.json({error:"performanceId query parameter is required"},{status:400});let{data:c,error:d}=await u.N.from("performances").select("id,title,description,date,location,call_time,phone_numbers,stage_orientation,timezone,music_file_path,music_file_name").eq("id",b).single();if(d)return v.NextResponse.json({error:"Failed to fetch performance",details:d.message},{status:500});if(!c)return v.NextResponse.json({error:"Performance not found"},{status:404});let{data:e,error:f}=await u.N.from("performance_contacts").select("id,name,phone,include_in_export").eq("performance_id",b).order("created_at",{ascending:!0});if(f)throw f;let{data:g,error:h}=await u.N.from("parts").select("id,name,description,order,timepoint_seconds,timepoint_end_seconds").eq("performance_id",b);if(h)throw h;let i=(g||[]).map(a=>a.id),j={},k={},l={},m={};if(i.length>0){let{data:a,error:b}=await u.N.from("stage_positions").select(`
          id,
          part_id,
          student_id,
          x,
